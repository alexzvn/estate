...
<div class="col-md-12">
    <div class="statbox widget box shadow-none rounded mb-3">
        ...
        <div class="widget-content widget-content-area shadow-none">
                ...
                <table id="example" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="text-secondary font-weight-bold">{{ $phone->phone }}</span></td>
            ...
            {{ $whitelist->onEachSide(0)->withQueryString()->render() }}
...
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="{{ route('manager.whitelist.phone.store') }}" method="post"> @csrf
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.delete').on('click', function () {
            ...
            form.attr('action', `/manager/whitelist/phone/${id}/delete`);
