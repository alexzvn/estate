        ...
        <div class="widget-content widget-content-area">
            ...
            <div class="table-responsive">
                ...
                <div class="btn-group mb-4 mr-2" role="group">
                    <button id="btndefault" onclick="$('#sub-action').toggleClass('d-block')" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Hành động 
